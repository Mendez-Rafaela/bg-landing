...
└── src/
    ...
    │   ├── hero-bg.webp       ← Imagem de fundo do hero
    │   ├── abstract-bg.webp   ← Fundo geométrico da seção estoque
    │   ├── cta-bg.webp        ← Fundo da seção CTA
    │   └── cars-showcase.webp ← Imagem dos veículos
    ├── js/
    │   └── script.js          ← JavaScript da landing page
    └── pages/
        ├── area-logada.html   ← Portal de gestão de estoque
